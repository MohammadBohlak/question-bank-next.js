...
const EditUserDialog = ({
    ...
    const handleSelectChange = (field: keyof CreateUserFormData, value: string) => {
        setFormData(prev => ({
            ...prev,
            ...
            <DialogContent className="sm:max-w-[650px] rounded-2xl border-0 shadow-2xl bg-white dark:bg-gray-800">
                ...
                <div className="space-y-6 py-2">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            <div className="space-y-3">
                                <Label htmlFor="edit-nameAr" className="text-sm font-semibold text-gray-700 dark:text-gray-300">
                            ...
                            <div className="space-y-3">
                                <Label htmlFor="edit-fatherNameAr" className="text-sm font-semibold text-gray-700 dark:text-gray-300">
                            ...
                            <div className="space-y-3">
                                <Label htmlFor="edit-surnameAr" className="text-sm font-semibold text-gray-700 dark:text-gray-300">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            <div className="space-y-3">
                                <Label htmlFor="edit-nameEn" className="text-sm font-semibold text-gray-700 dark:text-gray-300">
                            ...
                            <div className="space-y-3">
                                <Label htmlFor="edit-fatherNameEn" className="text-sm font-semibold text-gray-700 dark:text-gray-300">
                            ...
                            <div className="space-y-3">
                                <Label htmlFor="edit-surnameEn" className="text-sm font-semibold text-gray-700 dark:text-gray-300">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-3">
                            <Label htmlFor="edit-userName" className="text-sm font-semibold text-gray-700 dark:text-gray-300">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="space-y-3">
                            <Label htmlFor="edit-gender" className="text-sm font-semibold text-gray-700 dark:text-gray-300">
                            ...
                            >
                                <SelectTrigger className="rounded-xl border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white">
                                    <SelectValue placeholder={t('createDialog.genderPlaceholder')} />
                                </SelectTrigger>
                        ...
                        <div className="space-y-3">
                            <Label htmlFor="edit-mobile" className="text-sm font-semibold text-gray-700 dark:text-gray-300">
                    ...
                    {/* Address */}
                    <div className="space-y-3">
                        <Label htmlFor="edit-address" className="text-sm font-semibold text-gray-700 dark:text-gray-300">
