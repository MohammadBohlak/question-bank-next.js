...
const Sidebar = () => {
  ...
  return (
    <aside
      className={cn(
        "h-screen bg-card-bg shadow-2xl border-l border-1 dark:bg-gray-900 border-r border-border dark:border-gray-800 no-print flex flex-col justify-between transition-all duration-300",
        // collapsed ? "w-20" : "w-64",
        collapsed ? " w-14" : "w-64",
      )}
      // dir=""
              ...
              <div key={idx} className="relative group">
                ...
                >
                  <Icon
                    className={cn(
                      "w-5 h-5",
                      isActive ? "text-white" : "text-prim dark:text-blue-400",
                    )}
                  />
                  {!collapsed && (
