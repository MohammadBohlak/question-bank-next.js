        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
              ...
              <Button
                className="gap-2 rounded-xl bg-btn text-white shadow-lg hover:opacity-80 hover:shadow-xl transition-all"
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              {[
                ...
                <Card
                  key={idx}
                  // إضافة border-r-4 لسمك البوردر، وتطبيق لون البوردر بناءً على الاتجاه
                  className={`
      ...
      `}
            ...
            <div className="w-full mb-8">
              <div className="bg-white dark:bg-gray-800/50 rounded-xl border border-border-light dark:border-gray-700 overflow-hidden">
                {/* 
       grid-cols-1: مربع واحد في السطر للجوال.
       md:grid-cols-2: مربعين في السطر للأجهزة اللوحية.
       lg:grid-cols-4: 4 مربعات للشاشات الكبيرة.
       divide-y: فواصل أفقية (افتراضية للجوال).
       md:divide-y-0 md:divide-x: إلغاء الفواصل الأفقية واستبدالها برأسية للشاشات المتوسطة فما فوق.
    */}
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-6">
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    className="pl-10 rounded-xl border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 f-input"
                  />
                </div>
              </div>
            </CardHeader>
