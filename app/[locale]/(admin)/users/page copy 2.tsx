              ...
              <div className="flex flex-col lg:flex-row gap-4 mt-6">
                ...
                <div className="w-full lg:w-48">
                  <Select value={statusFilter} onValueChange={setStatusFilter}>
                    <SelectTrigger className="rounded-xl border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                ...
                <div className="w-full lg:w-64">
                  <Select value={sortBy} onValueChange={setSortBy}>
                    ...
                    <SelectContent>
                      <SelectItem value="dateDesc">الأحدث إنشاءاً</SelectItem>
                      <SelectItem value="dateAsc">الأقدم إنشاءاً</SelectItem>
              ...
              {selectedIds.length > 0 && (
                <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl flex items-center justify-between animate-in fade-in slide-in-from-top-2">
                  <div className="flex items-center gap-2 text-sm font-medium text-blue-800 dark:text-blue-200">
                    ...
                    <span>{selectedIds.length} مستخدم محدد</span>
                  </div>
                  <Button
                    variant="destructive"
                    size="sm"
