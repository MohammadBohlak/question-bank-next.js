...
// استيراد الأيقونات: أيقونة الدخول الجديدة، بالإضافة لأيقونات الحقول
import { User, Lock, Eye, EyeOff, LogIn } from "lucide-react";

const Login = () => {
  const [username, setUsername] = useState("");
  const [password, setPassword] = useState("");
  const [showPassword, setShowPassword] = useState(false); // لحالة إظهار/إخفاء كلمة المرور
    ...
    >
      ...
      >
        ...
        <div
          ...
          bg-gradient-to-b from-[#2ab3f7] to-[#141a73]
          text-white p-10
          transition-colors duration-300
        "
        >
        ...
        <div className="p-8 md:p-10 flex flex-col justify-center">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-blue-50 dark:bg-blue-900/30 mb-4 text-blue-600 dark:text-blue-400 shadow-sm border border-blue-100 dark:border-blue-800">
                <LogIn size={32} strokeWidth={2} className="text-blue-900 " />
              </div>
              <h2 className="text-2xl font-bold text-blue-900 font-arabic">
                تسجيل الدخول
              </h2>
              <p className="text-sm text-blue-700 font-semibold  font-arabic mt-2">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors focus:outline-none cursor-pointer"
                >
            ...
            <button
              ...
              ${
                valid
                  ? "bg-gradient-to-b from-[#2ab3f7] to-[#141a73] hover:opacity-90 shadow-lg dark:shadow-blue-900/30 text-white"
